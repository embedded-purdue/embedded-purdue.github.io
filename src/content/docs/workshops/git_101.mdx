...
This workshop is designed for both beginning and intermediate Git users. Even if you have some experience with Git, knowing how to effectively use it in a team setting is **crucial**! This workshop will help you understand how to use Git and GitHub for version control, collaboration, and project management.

Follow along with the slides, and complete the tasks as they appear. Use the Git cheat sheet for a short list of the commands learned in this workshop for future reference.
...
- **GitHub Account**: If you don't already have one, create a GitHub account at [github.com](https://github.com).
- **Git Installation**: Install Git on your computer. Follow the instructions for your operating system:
      1. Check if Git is already installed by running `git `in your terminal or command prompt:
            ```bash
            git --version
            ```
      2. If not, install Git for your OS:
          - [Windows](https://git-scm.com/download/win)
          - [macOS](https://git-scm.com/download/mac)
          - [Linux](https://git-scm.com/download/linux)

### Task 1: Create and Clone a Repository
...
- Fill in the repository name and an optional description. We can call this one `git-101`.
- Choose the repository visibility (**Public** or **Private**). Ours willl be **Public** so we don't have to worry about setting up an [SSH key](https://www.atlassian.com/git/tutorials/git-ssh).
