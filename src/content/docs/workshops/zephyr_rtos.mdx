...
![zephyr meme](../../../assets/rtos.jpeg)

import { Badge } from '@astrojs/starlight/components';

<br />

<Badge text="Level: Advanced" variant="danger" />  <Badge text="Offerred: Fall 2025" variant="note" /> <Badge text="Workshop leader: Alex Aylward" variant="tip" />
