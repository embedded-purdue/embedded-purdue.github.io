...
![git meme](../../../assets/cpp_meme.jpg)

import { Badge } from '@astrojs/starlight/components';

<br />

<Badge text="Level: Intermediate" variant="caution" />  <Badge text="Offerred: Fall 2025" variant="note" /> <Badge text="Workshop leader: Alex Aylward" variant="tip" />
